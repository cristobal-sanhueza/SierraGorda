...
La Figura 3.7 muestra el ciclo horario de las concentraciones de MP10 (µg/m3) medida y modelada en la estación Sierra Gorda para el mes de `r MesDelReporte` del 2023. A pesar de que el modelo logra captar el ciclo y tendencia de los niveles de MP10, los valores en la mayoría de las horas está subestimada. Cabe destacar que ésto no se había notado en meses anteriores por lo tanto vemos que las condiciones de las fuentes han cambiado. Se recalculará el modelo para los próximos meses.
