...
La Figura 3.7 muestra el ciclo horario de las concentraciones de MP10 (µg/m3) medida y modelada en la estación Sierra Gorda para el mes de `r MesDelReporte` del 2023. A pesar de que el modelo logra captar el ciclo y tendencia de los niveles de MP10, los valores en la mayoría de las horas está sobreestimada.
...
La Tabla III.5 muestra la Exactitud del modelo de pronóstico para el período evaluado en la estación de Sierra Gorda. De ella se observa que en promedio, el acierto del modelo es de un `r label_percent(1)(promedio)`, para el período de `r MesDelReporte` 2023.
