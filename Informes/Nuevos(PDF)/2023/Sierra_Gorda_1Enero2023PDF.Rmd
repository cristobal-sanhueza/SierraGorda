...
MP10_Modelados <- list.files(path = "SIERRA_GORDA/Modelados/pronostico-alerta/sg/2023/1.Enero/MP10/Nuevos",
                               pattern = "*.xlsx",
                               full.names = TRUE) %>%
  lapply(read_excel)
...
MP10_Observados <- read_excel("SIERRA_GORDA/Observados/2023/1.Enero/MP10/Consultas en Linea.xlsx")
...
Met_Modelados <- list.files(path = "SIERRA_GORDA/Modelados/pronostico-alerta/sg/2023/1.Enero/Meteorologia",    
                            pattern = "*.xlsx",
                            full.names = TRUE) %>% 
  lapply(read_excel) 
...
Met_Observados <- read_excel("SIERRA_GORDA/Observados/2023/1.Enero/Meteorologia/Consultas en Linea.xlsx")
...
df <- data.frame(`Nº Proyecto` = c("G12-21"),
                 Elaboración = c("CSD 06-02-23"),
                 `Revisión A` = c("MTV 06-02-23"),
                 Aprobó = c("PSH 06-02-23"),
                 Versión = "V1")
