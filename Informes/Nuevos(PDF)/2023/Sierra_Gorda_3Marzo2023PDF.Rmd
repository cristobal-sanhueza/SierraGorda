...
MP10_Modelados <- list.files(path = "SIERRA_GORDA/Modelados/pronostico-alerta/sg/2023/3.Marzo/MP10",
                               pattern = "*.xlsx",
                               full.names = TRUE) %>%
  lapply(read_excel)
...
MP10_Observados <- read_excel("SIERRA_GORDA/Observados/2023/3.Marzo/MP10/Consultas en Linea.xlsx")
...
Met_Modelados <- list.files(path = "SIERRA_GORDA/Modelados/pronostico-alerta/sg/2023/3.Marzo/Meteorologia",    
                            pattern = "*.xlsx",
                            full.names = TRUE) %>% 
  lapply(read_excel) 
...
Met_Observados <- read_excel("SIERRA_GORDA/Observados/2023/3.Marzo/Meteorologia/Consultas en Linea.xlsx")
...
df <- data.frame(`Nº Proyecto` = c("G12-21"),
                 Elaboración = c("CSD 04-04-23"),
                 `Revisión A` = c("MTV 04-04-23"),
                 Aprobó = c("PSH 04-04-23"),
                 Versión = "V1")
