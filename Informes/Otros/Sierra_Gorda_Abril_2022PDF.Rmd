...
df <- data.frame(`Nº Proyecto` = c("G12-21"),
                 Elaboración = c("CSD 03-10-22"),
                 `Revisión A` = c("MTV 03-10-22"),
                 Aprobó = c("PSH 03-10-22"),
                 Versión = "V1")
...
Mauricio Acevedo V.               \hfill Superintendente de Medio Ambiente SGSCM  
