...
MP10_Modelados <- list.files(path = "SIERRA_GORDA/Modelados/pronostico-alerta/sg/2022/11.Noviembre/MP10",
                               pattern = "*.xlsx",
                               full.names = TRUE) %>%
  lapply(read_excel)
...
MP10_Observados <- read_excel("SIERRA_GORDA/Observados/2022/11.Noviembre/MP10/Consultas en Linea.xlsx")
...
Met_Modelados <- list.files(path = "SIERRA_GORDA/Modelados/pronostico-alerta/sg/2022/11.Noviembre/Meteorologia",    
                            pattern = "*.xlsx",
                            full.names = TRUE) %>% 
  lapply(read_excel) 
...
Met_Observados <- read_excel("SIERRA_GORDA/Observados/2022/11.Noviembre/Meteorologia/Consultas en Linea.xlsx")
...
df <- data.frame(`Nº Proyecto` = c("G12-21"),
                 Elaboración = c("CSD 03-12-22"),
                 `Revisión A` = c("MTV 03-12-22"),
                 Aprobó = c("PSH 03-12-22"),
                 Versión = "V1")
