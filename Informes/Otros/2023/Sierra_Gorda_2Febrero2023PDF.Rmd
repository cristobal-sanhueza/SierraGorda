...
MesDelReporte = "febrero"
  
FechaEntrega = "Marzo 2023"
...
MP10_Modelados <- list.files(path = "SIERRA_GORDA/Modelados/pronostico-alerta/sg/2023/2.Febrero/Adjusted",
                               pattern = "*.xlsx",
                               full.names = TRUE) %>%
  lapply(read_excel)
...
MP10_Observados <- read_excel("SIERRA_GORDA/Observados/2023/2.Febrero/MP10/Consultas en Linea.xlsx")
...
Met_Modelados <- list.files(path = "SIERRA_GORDA/Modelados/pronostico-alerta/sg/2023/2.Febrero/Meteorologia",    
                            pattern = "*.xlsx",
                            full.names = TRUE) %>% 
  lapply(read_excel) 
...
Met_Observados <- read_excel("SIERRA_GORDA/Observados/2023/2.Febrero/Meteorologia/Consultas en Linea.xlsx")
...
df <- data.frame(`Nº Proyecto` = c("G12-21"),
                 Elaboración = c("CSD 03-03-23"),
                 `Revisión A` = c("MTV 03-03-23"),
                 Aprobó = c("PSH 03-03-23"),
                 Versión = "V1")
...
La Figura 3.7 muestra el ciclo horario de las concentraciones de MP10 (µg/m3) medida y modelada en la estación Sierra Gorda para el mes de `r MesDelReporte` del 2023. De ella se observa que el modelo de pronóstico logra reproducir el ciclo diario del MP10 en Sierra Gorda.
